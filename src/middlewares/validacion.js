...
exports.verAdHotel = function(req, res, next) {
    if(req.user.rol !== "HOTEL") return res.status(403).send({mensaje: "Solo puede acceder los administradores de los hoteles"})
